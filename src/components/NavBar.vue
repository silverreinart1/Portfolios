<template>
    ...
    <nav class="bg-gradient-to-r from-gray-900 to-black flex items-center py-4 px-8 shadow-lg">
      <router-link to="portfolio" class="text-[#d4bea4] font-bold text-lg tracking-widest mr-8 uppercase animate-ping animate-infinite animate-ease-linear animate-alternate animate-fill-both">SILVER</router-link>
      ...
      <router-link 
        to="/talk" 
        class="ml-auto bg-[#d4bea4] text-black font-semibold text-xs uppercase px-4 py-2 rounded-md border-2 border-transparent transition duration-300 hover:bg-transparent hover:border-[#d4bea4] hover:text-[#d4bea4] animate-bounce-constant">
        Let's talk about
      </router-link>
    </nav>
